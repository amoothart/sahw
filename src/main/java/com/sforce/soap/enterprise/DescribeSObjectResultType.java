 ...
 *       &lt;sequence>
 *         &lt;element name="actionOverrides" type="{urn:enterprise.soap.sforce.com}ActionOverride" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="namedLayoutInfos" type="{urn:enterprise.soap.sforce.com}NamedLayoutInfo" maxOccurs="unbounded" minOccurs="0"/>
...
public class DescribeSObjectResultType {
    ...
    protected List<ActionOverrideType> actionOverrides;
    ...
    protected List<NamedLayoutInfoType> namedLayoutInfos;
     ...
     * 
     */
    public List<ActionOverrideType> getActionOverrides() {
        if (actionOverrides == null) {
            actionOverrides = new ArrayList<ActionOverrideType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NamedLayoutInfoType }
     * 
     * 
     */
    public List<NamedLayoutInfoType> getNamedLayoutInfos() {
        if (namedLayoutInfos == null) {
            namedLayoutInfos = new ArrayList<NamedLayoutInfoType>();
        }
