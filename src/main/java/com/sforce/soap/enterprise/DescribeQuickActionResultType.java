 ...
 *       &lt;sequence>
 *         &lt;element name="accessLevelRequired" type="{urn:enterprise.soap.sforce.com}ShareAccessLevel"/>
 ...
 *         &lt;element name="defaultValues" type="{urn:enterprise.soap.sforce.com}DescribeQuickActionDefaultValue" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="layout" type="{urn:enterprise.soap.sforce.com}DescribeLayoutSection" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="targetRecordTypeId" type="{urn:enterprise.soap.sforce.com}ID"/>
...
public class DescribeQuickActionResultType {
    ...
    public List<DescribeLayoutSectionType> getLayout() {
        if (layout == null) {
            layout = new ArrayList<DescribeLayoutSectionType>();
        }
        return this.layout;
    }
