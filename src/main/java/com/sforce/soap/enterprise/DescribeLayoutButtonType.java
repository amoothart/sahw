...
public class DescribeLayoutButtonType {
    ...
    @XmlElementRef(name = "behavior", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<WebLinkWindowTypeType> behavior;
    protected List<DescribeColorType> colors;
    @XmlElementRef(name = "content", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> content;
    @XmlElementRef(name = "contentSource", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<WebLinkTypeType> contentSource;
    protected boolean custom;
    @XmlElementRef(name = "encoding", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "width", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    protected JAXBElement<WebLinkPositionType> windowPosition;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WebLinkWindowTypeType }{@code >}
     *     
     */
    public JAXBElement<WebLinkWindowTypeType> getBehavior() {
        return behavior;
    }
     ...
     *     
     */
    public void setBehavior(JAXBElement<WebLinkWindowTypeType> value) {
        this.behavior = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WebLinkTypeType }{@code >}
     *     
     */
    public JAXBElement<WebLinkTypeType> getContentSource() {
     ...
     *     
     */
    public void setContentSource(JAXBElement<WebLinkTypeType> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WebLinkPositionType }{@code >}
     *     
     */
    public JAXBElement<WebLinkPositionType> getWindowPosition() {
     ...
     *     
     */
    public void setWindowPosition(JAXBElement<WebLinkPositionType> value) {
