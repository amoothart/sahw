...
@XmlEnum
public enum WebLinkWindowTypeType {
    ...
    WebLinkWindowTypeType(String v) {
        value = v;
    }
    ...
    public static WebLinkWindowTypeType fromValue(String v) {
        for (WebLinkWindowTypeType c: WebLinkWindowTypeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
