...
public class SearchRecordType {
    ...
    @XmlElementRef(name = "snippet", namespace = "urn:enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<SearchSnippetType> snippet;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SearchSnippetType }{@code >}
     *     
     */
    public JAXBElement<SearchSnippetType> getSnippet() {
        return snippet;
    }
     ...
     *     
     */
    public void setSnippet(JAXBElement<SearchSnippetType> value) {
        this.snippet = value;
    }
