    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Binary", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ContentSource", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "HtmlWrapper", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SupportsCaching", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
