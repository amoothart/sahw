...
/**
 * <p>Java class for TopicFeed complex type.
 * 
 ...
 *         &lt;element name="Parent" type="{urn:sobject.enterprise.soap.sforce.com}Topic" minOccurs="0"/>
...
@XmlType(name = "TopicFeed", propOrder = {
    "body",
    "commentCount",
    "contentData",
    "contentDescription",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Topic> parent;
     ...
     *     
     */
    public JAXBElement<Topic> getParent() {
        return parent;
    }
     ...
     *     
     */
    public void setParent(JAXBElement<Topic> value) {
        this.parent = value;
    }
