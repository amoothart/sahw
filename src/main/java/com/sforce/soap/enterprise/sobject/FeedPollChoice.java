...
/**
 * <p>Java class for FeedPollChoice complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ChoiceBody" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="FeedPollVotes" type="{urn:enterprise.soap.sforce.com}QueryResult" minOccurs="0"/>
...
@XmlType(name = "FeedPollChoice", propOrder = {
    "choiceBody",
    "createdBy",
    "createdById",
    "createdDate",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "ChoiceBody", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> choiceBody;
    ...
    protected JAXBElement<QueryResultType> feedPollVotes;
    ...
    protected JAXBElement<Integer> position;

    /**
     * Gets the value of the choiceBody property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getChoiceBody() {
        return choiceBody;
    }

    /**
     * Sets the value of the choiceBody property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setChoiceBody(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<QueryResultType> getFeedPollVotes() {
        return feedPollVotes;
    }

    /**
     * Sets the value of the feedPollVotes property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link QueryResultType }{@code >}
     *     
     */
    public void setFeedPollVotes(JAXBElement<QueryResultType> value) {
        this.feedPollVotes = value;
    }
     ...
     *     
     */
    public JAXBElement<Integer> getPosition() {
        return position;
    }
     ...
     *     
     */
    public void setPosition(JAXBElement<Integer> value) {
        this.position = value;
    }
