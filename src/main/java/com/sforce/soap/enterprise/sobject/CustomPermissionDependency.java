    ...
    extends SObject
{
    ...
    protected JAXBElement<CustomPermission> requiredCustomPermission;
    @XmlElementRef(name = "RequiredCustomPermissionId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> requiredCustomPermissionId;
     ...
     *     
     */
    public void setRequiredCustomPermission(JAXBElement<CustomPermission> value) {
     ...
     *     
     */
    public JAXBElement<String> getRequiredCustomPermissionId() {
     ...
     *     
     */
    public void setRequiredCustomPermissionId(JAXBElement<String> value) {
