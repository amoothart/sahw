    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "AmountUsed", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> amountUsed;
    ...
    @XmlElementRef(name = "CurrentAmountAllowed", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> currentAmountAllowed;
    ...
    @XmlElementRef(name = "Frequency", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> frequency;
    @XmlElementRef(name = "HasRollover", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> hasRollover;
    ...
    @XmlElementRef(name = "IsPersistentResource", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isPersistentResource;
    ...
    @XmlElementRef(name = "OverageGrace", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> overageGrace;
    @XmlElementRef(name = "ResourceGroupKey", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> resourceGroupKey;
    @XmlElementRef(name = "Setting", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "UsageDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> usageDate;
     ...
     *     
     */
    public JAXBElement<Double> getAmountUsed() {
        return amountUsed;
    }
     ...
     *     
     */
    public void setAmountUsed(JAXBElement<Double> value) {
     ...
     *     
     */
    public JAXBElement<Double> getCurrentAmountAllowed() {
     ...
     *     
     */
    public void setCurrentAmountAllowed(JAXBElement<Double> value) {
     ...
     *     
     */
    public JAXBElement<Boolean> getHasRollover() {
        return hasRollover;
    }
     ...
     *     
     */
    public void setHasRollover(JAXBElement<Boolean> value) {
     ...
     *     
     */
    public JAXBElement<Boolean> getIsPersistentResource() {
     ...
     *     
     */
    public void setIsPersistentResource(JAXBElement<Boolean> value) {
     ...
     *     
     */
    public JAXBElement<Double> getOverageGrace() {
        return overageGrace;
    }
     ...
     *     
     */
    public void setOverageGrace(JAXBElement<Double> value) {
     ...
     *     
     */
    public JAXBElement<String> getResourceGroupKey() {
     ...
     *     
     */
    public void setResourceGroupKey(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getUsageDate() {
        return usageDate;
    }
     ...
     *     
     */
    public void setUsageDate(JAXBElement<XMLGregorianCalendar> value) {
