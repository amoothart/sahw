...
/**
 * <p>Java class for FeedPollVote complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Choice" type="{urn:sobject.enterprise.soap.sforce.com}FeedPollChoice" minOccurs="0"/>
 *         &lt;element name="ChoiceId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
...
@XmlType(name = "FeedPollVote", propOrder = {
    "choice",
    "choiceId",
    "createdBy",
    "createdById",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Choice", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<FeedPollChoice> choice;
    @XmlElementRef(name = "ChoiceId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> choiceId;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FeedPollChoice }{@code >}
     *     
     */
    public JAXBElement<FeedPollChoice> getChoice() {
        return choice;
    }
     ...
     *     
     */
    public void setChoice(JAXBElement<FeedPollChoice> value) {
        this.choice = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getChoiceId() {
        return choiceId;
    }
     ...
     *     
     */
    public void setChoiceId(JAXBElement<String> value) {
        this.choiceId = value;
    }
