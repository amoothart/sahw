...
/**
 * <p>Java class for AssetTag complex type.
 * 
 ...
 *         &lt;element name="Item" type="{urn:sobject.enterprise.soap.sforce.com}Asset" minOccurs="0"/>
...
@XmlType(name = "AssetTag", propOrder = {
    "createdDate",
    "isDeleted",
    "item",
    "itemId",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Asset> item;
     ...
     *     
     */
    public JAXBElement<Asset> getItem() {
        return item;
    }
     ...
     *     
     */
    public void setItem(JAXBElement<Asset> value) {
        this.item = value;
    }
