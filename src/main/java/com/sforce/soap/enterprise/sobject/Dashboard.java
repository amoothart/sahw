    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "DashboardResultRefreshedDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dashboardResultRefreshedDate;
    @XmlElementRef(name = "DashboardResultRunningUser", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dashboardResultRunningUser;
     ...
     *     
     */
    public JAXBElement<String> getDashboardResultRefreshedDate() {
     ...
     *     
     */
    public void setDashboardResultRefreshedDate(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getDashboardResultRunningUser() {
     ...
     *     
     */
    public void setDashboardResultRunningUser(JAXBElement<String> value) {
