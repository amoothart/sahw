    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsAvailableInTouch", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isAvailableInTouch;
    @XmlElementRef(name = "IsConfirmationTokenRequired", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isConfirmationTokenRequired;
