    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CampaignMemberRecordType", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<RecordType> campaignMemberRecordType;
     ...
     *     
     */
    public JAXBElement<RecordType> getCampaignMemberRecordType() {
     ...
     *     
     */
    public void setCampaignMemberRecordType(JAXBElement<RecordType> value) {
