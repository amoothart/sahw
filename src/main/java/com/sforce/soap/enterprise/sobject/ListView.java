 ...
 *         &lt;element name="IsSoqlCompatible" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsSoqlCompatible", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isSoqlCompatible;
     ...
     *     
     */
    public void setIsSoqlCompatible(JAXBElement<Boolean> value) {
