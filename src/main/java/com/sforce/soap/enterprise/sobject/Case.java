    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "HasCommentsUnreadByOwner", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> hasCommentsUnreadByOwner;
    @XmlElementRef(name = "HasSelfServiceComments", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class, required = false)
