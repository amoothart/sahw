 ...
 *         &lt;element name="operator" type="{urn:enterprise.soap.sforce.com}soqlOperator"/>
...
public class SoqlSubQueryConditionType
    extends SoqlWhereConditionType
{
    ...
    protected SoqlOperatorType operator;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link SoqlOperatorType }
     *     
     */
    public SoqlOperatorType getOperator() {
        return operator;
    }
     ...
     *     
     */
    public void setOperator(SoqlOperatorType value) {
        this.operator = value;
    }
