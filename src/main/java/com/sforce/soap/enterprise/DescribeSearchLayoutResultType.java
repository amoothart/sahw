 ...
 *         &lt;element name="searchColumns" type="{urn:enterprise.soap.sforce.com}DescribeColumn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DescribeSearchLayoutResultType {
    ...
    protected List<DescribeColumnType> searchColumns;
     ...
     * {@link DescribeColumnType }
     * 
     * 
     */
    public List<DescribeColumnType> getSearchColumns() {
        if (searchColumns == null) {
            searchColumns = new ArrayList<DescribeColumnType>();
        }
