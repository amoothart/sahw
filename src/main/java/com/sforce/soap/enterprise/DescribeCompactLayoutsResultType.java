 ...
 *       &lt;sequence>
 *         &lt;element name="compactLayouts" type="{urn:enterprise.soap.sforce.com}DescribeCompactLayout" maxOccurs="unbounded"/>
 *         &lt;element name="defaultCompactLayoutId" type="{urn:enterprise.soap.sforce.com}ID"/>
 *         &lt;element name="recordTypeCompactLayoutMappings" type="{urn:enterprise.soap.sforce.com}RecordTypeCompactLayoutMapping" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DescribeCompactLayoutsResultType {

    @XmlElement(required = true)
    protected List<DescribeCompactLayoutType> compactLayouts;
    @XmlElement(required = true)
    protected String defaultCompactLayoutId;
    @XmlElement(required = true)
    protected List<RecordTypeCompactLayoutMappingType> recordTypeCompactLayoutMappings;
     ...
     * {@link DescribeCompactLayoutType }
     * 
     * 
     */
    public List<DescribeCompactLayoutType> getCompactLayouts() {
        if (compactLayouts == null) {
            compactLayouts = new ArrayList<DescribeCompactLayoutType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RecordTypeCompactLayoutMappingType }
     * 
     * 
     */
    public List<RecordTypeCompactLayoutMappingType> getRecordTypeCompactLayoutMappings() {
        if (recordTypeCompactLayoutMappings == null) {
            recordTypeCompactLayoutMappings = new ArrayList<RecordTypeCompactLayoutMappingType>();
        }
