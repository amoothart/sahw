 ...
 *         &lt;element name="languages" type="{urn:enterprise.soap.sforce.com}KnowledgeLanguageItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class KnowledgeSettingsType {

    protected String defaultLanguage;
    protected boolean knowledgeEnabled;
    protected List<KnowledgeLanguageItemType> languages;
     ...
     * {@link KnowledgeLanguageItemType }
     * 
     * 
     */
    public List<KnowledgeLanguageItemType> getLanguages() {
        if (languages == null) {
            languages = new ArrayList<KnowledgeLanguageItemType>();
        }
