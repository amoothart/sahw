 ...
 *       &lt;sequence>
 *         &lt;element name="accessLevelRequiredForCreate" type="{urn:enterprise.soap.sforce.com}ShareAccessLevel"/>
 *         &lt;element name="buttons" type="{urn:enterprise.soap.sforce.com}DescribeLayoutButton" maxOccurs="unbounded" minOccurs="0"/>
...
public class RelatedListType {
    ...
    protected ShareAccessLevelType accessLevelRequiredForCreate;
    @XmlElement(nillable = true)
    protected List<DescribeLayoutButtonType> buttons;
     ...
     *     
     */
    public ShareAccessLevelType getAccessLevelRequiredForCreate() {
     ...
     *     
     */
    public void setAccessLevelRequiredForCreate(ShareAccessLevelType value) {
     ...
     * 
     */
    public List<DescribeLayoutButtonType> getButtons() {
        if (buttons == null) {
            buttons = new ArrayList<DescribeLayoutButtonType>();
        }
        return this.buttons;
    }
